...
@section('content')
    <div class="content">
        <button><a href="{{ route('user.index') }}">Voir Users</a></button><br>
        ...
        @foreach ($boissons as $boisson)
            <div>
                <a href="/boissons/{{ $boisson->id }}"> <img
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIutu58PLX8lslqjjowYVSicWXbZueDQHMrw&usqp=CAU"
                        alt="boisson"></a>
                <h2>Description:</h2>
                <div>
                ...
                <form action="{{ route('.boisson.deletephoto', $boisson->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
