...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            @if (Auth::check())
            <a class="navbar-brand js-scroll-trigger" href={{ url('/home') }}><img
                src="{{ asset('assets/img/navbar-logo.svg') }}" alt="" /></a>
            @else
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ml-auto">
                    ...
                    @else
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="{{ route('users.index') }}">Equipe</a></li>
                     
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" aria-labelledby="navbarDropdown"
                                href="{{ route('users.show', Auth::user()->id) }}">Ma Galerie</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="{{ route('logout') }}" onclick="event.preventDefault();
